...
const TargetCursor: React.FC<TargetCursorProps> = ({
  targetSelector = 'a, button, input, textarea, select, .cursor-target',
  spinDuration = 4,
  ...
  useEffect(() => {
    ...
    const enterHandler = (e: MouseEvent) => {
      ...
      // Make brackets expand to fit the item
      const padding = 6;
      targetCornerPositionsRef.current = [
        { x: rect.left - padding - borderWidth - offsetX, y: rect.top - padding - borderWidth - offsetY },
        { x: rect.right + padding + borderWidth - cornerSize - offsetX, y: rect.top - padding - borderWidth - offsetY },
        { x: rect.right + padding + borderWidth - cornerSize - offsetX, y: rect.bottom + padding + borderWidth - cornerSize - offsetY },
        { x: rect.left - padding - borderWidth - offsetX, y: rect.bottom + padding + borderWidth - cornerSize - offsetY }
      ];
      ...
      const leaveHandler = () => {
        ...
        if (cornersRef.current) {
          ...
          corners.forEach((corner, index) => {
            tl.to(corner, { x: positions[index].x, y: positions[index].y, duration: 0.25, ease: 'power3.out' }, 0);
          });
        }
  ...
  return (
    <div ref={cursorRef} className="target-cursor-wrapper">
      <div className="cursor-sfx-label bangers">TARGET!</div>
